#' Modular VA-Calibration for Fixed Misclassification Matrix
#'
#' @import patchwork
#' @import rstan
#' @import ggplot2
...
#'
modular_vacalib_fixed <- function(va_unlabeled = NULL,
  ...
  if(plot_it){
    ...
    Mmat_toplot_input = round(100*output$Mmat_input)
    ...
    Mmat_toplot_study = round(100*output$Mmat_study)
    ...
    Mmat_toplot_tomodel = round(100*output$Mmat_tomodel)
